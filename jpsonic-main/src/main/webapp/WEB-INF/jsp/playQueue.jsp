    ...
    <div class="actions">
        <ul class="controls">
            ...
            <c:if test="${model.user.shareRole and model.showShare}">
                <li><a title="<fmt:message key='main.sharealbum'/>" href="javascript:top.upper.document.getElementById('main').src = 'createShare.view?player=${model.player.id}&' + getSelectedIndexes();" target="main" class="control share"><fmt:message key="main.sharealbum"/></a></li>
            </c:if>
